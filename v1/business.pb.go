...
type DynamoBusiness struct {
	...
	// @gotags: dynamodbav:"pk"
	Pk string `protobuf:"bytes,1,opt,name=pk,proto3" json:"pk,omitempty" dynamodbav:"pk"`
	// @gotags: dynamodbav:"sk"
	Sk string `protobuf:"bytes,2,opt,name=sk,proto3" json:"sk,omitempty" dynamodbav:"sk"`
	// @gotags: dynamodbav:"business_pk"
	BusinessPk string `protobuf:"bytes,3,opt,name=business_pk,json=businessPk,proto3" json:"business_pk,omitempty" dynamodbav:"business_pk"`
	// @gotags: dynamodbav:"business_sk"
	BusinessSk string `protobuf:"bytes,4,opt,name=business_sk,json=businessSk,proto3" json:"business_sk,omitempty" dynamodbav:"business_sk"`
	// @gotags: dynamodbav:"business_entity"
	BusinessEntity *BusinessData `protobuf:"bytes,5,opt,name=business_entity,json=businessEntity,proto3" json:"business_entity,omitempty" dynamodbav:"business_entity"`
}
...
func (x *BusinessRequest) GetBusinessId() string {
	if x != nil {
		return x.BusinessId
	}
	return ""
...
func (x *BusinessRequest) GetToken() string {
	if x != nil {
		return x.Token
	}
	return ""
...
func (x *AllBusinessRequest) Reset() {
	*x = AllBusinessRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *AllBusinessRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AllBusinessRequest) ProtoMessage() {}

func (x *AllBusinessRequest) ProtoReflect() protoreflect.Message {
	mi := &file_business_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AllBusinessRequest.ProtoReflect.Descriptor instead.
func (*AllBusinessRequest) Descriptor() ([]byte, []int) {
	return file_business_proto_rawDescGZIP(), []int{4}
}

func (x *AllBusinessRequest) GetToken() string {
	if x != nil {
		return x.Token
	}
	return ""
...
var file_business_proto_rawDesc = []byte{
	...
	0x48, 0x0a, 0x0f, 0x42, 0x75, 0x73, 0x69, 0x6e, 0x65, 0x73, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65,
	...
	0x73, 0x49, 0x64, 0x12, 0x14, 0x0a, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x18, 0x02, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x2a, 0x0a, 0x12, 0x41, 0x6c, 0x6c,
	0x42, 0x75, 0x73, 0x69, 0x6e, 0x65, 0x73, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12,
	0x14, 0x0a, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05,
	0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x42, 0x6b, 0x0a, 0x08, 0x63, 0x6f, 0x6d, 0x2e, 0x75, 0x73, 0x65,
	0x72, 0x42, 0x0d, 0x42, 0x75, 0x73, 0x69, 0x6e, 0x65, 0x73, 0x73, 0x50, 0x72, 0x6f, 0x74, 0x6f,
...
var file_business_proto_depIdxs = []int32{
	5, // 0: user.BusinessData.phone_numbers:type_name -> user.PhoneNumberData
...
func file_business_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_business_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AllBusinessRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
