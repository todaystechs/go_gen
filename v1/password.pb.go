...
func (x *RestPasswordToken) Reset() {
	*x = RestPasswordToken{}
	if protoimpl.UnsafeEnabled {
...
func (x *RestPasswordToken) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RestPasswordToken) ProtoMessage() {}

func (x *RestPasswordToken) ProtoReflect() protoreflect.Message {
	mi := &file_password_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RestPasswordToken.ProtoReflect.Descriptor instead.
func (*RestPasswordToken) Descriptor() ([]byte, []int) {
	return file_password_proto_rawDescGZIP(), []int{1}
}

func (x *RestPasswordToken) GetIssuedTo() string {
	if x != nil {
		return x.IssuedTo
	}
	return ""
...
func (x *RestPasswordToken) GetIssuedOn() string {
	if x != nil {
		return x.IssuedOn
	}
	return ""
...
func (x *RestPasswordToken) GetExpiresOn() string {
	if x != nil {
		return x.ExpiresOn
	}
	return ""
...
func (x *RestPasswordToken) GetToken() string {
	if x != nil {
		return x.Token
	}
	return ""
...
var file_password_proto_rawDesc = []byte{
	...
	0x52, 0x05, 0x65, 0x6d, 0x61, 0x69, 0x6c, 0x22, 0x82, 0x01, 0x0a, 0x11, 0x52, 0x65, 0x73, 0x74,
	0x50, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x12, 0x1b, 0x0a,
	...
	0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0xbd, 0x01, 0x0a,
	...
	0x6f, 0x6b, 0x65, 0x6e, 0x12, 0x2c, 0x0a, 0x0c, 0x6e, 0x65, 0x77, 0x5f, 0x70, 0x61, 0x73, 0x73,
	0x77, 0x6f, 0x72, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x42, 0x09, 0xba, 0xe9, 0xc0, 0x03,
	...
	0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x42, 0x09, 0xba, 0xe9,
	0xc0, 0x03, 0x04, 0x72, 0x02, 0x10, 0x08, 0x52, 0x0f, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x72, 0x6d,
	0x50, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x12, 0x22, 0x0a, 0x07, 0x75, 0x73, 0x65, 0x72,
	0x5f, 0x69, 0x64, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x42, 0x09, 0xba, 0xe9, 0xc0, 0x03, 0x04,
	0x72, 0x02, 0x10, 0x05, 0x52, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x42, 0x6b, 0x0a, 0x08,
	0x63, 0x6f, 0x6d, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x42, 0x0d, 0x50, 0x61, 0x73, 0x73, 0x77, 0x6f,
...
var file_password_proto_goTypes = []interface{}{
	...
	(*RestPasswordToken)(nil),  // 1: user.RestPasswordToken
...
func file_password_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_password_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*RestPasswordToken); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
