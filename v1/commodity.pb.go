...
type Commodity struct {
	...
	AdditionalServices []CommodityServices `protobuf:"varint,18,rep,packed,name=additional_services,json=additionalServices,proto3,enum=user.CommodityServices" json:"additional_services,omitempty" dynamodbav:"commodity_services,omitempty"`
