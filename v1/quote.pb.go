...
type Quote struct {
	...
	Pickup *Location `protobuf:"bytes,7,opt,name=pickup,json=pickup,omitempty,proto3" json:"pickup,omitempty"`
	// @gotags: dynamodbav:"delivery,omitempty"
	Delivery *Location `protobuf:"bytes,8,opt,name=delivery,json=delivery,omitempty,proto3" json:"delivery,omitempty"`
	// @gotags: dynamodbav:"commodities,omitempty"
	Commodities []*Commodity `protobuf:"bytes,9,rep,name=commodities,json=commodities,omitempty,proto3" json:"commodities,omitempty"`
	// @gotags: dynamodbav:"pickup_date,omitempty"
	PickupDate string `protobuf:"bytes,10,opt,name=pickup_date,json=pickup_date,omitempty,proto3" json:"pickup_date,omitempty"`
