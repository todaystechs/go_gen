...
type Quote struct {
	...
	VendorBids map[string]*any1.Any `protobuf:"bytes,14,rep,name=vendor_bids,json=vendorBids,proto3" json:"vendor_bids,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3" dynamodbav:"vendor_bids,omitempty"`
}
...
func (x *Quote) GetVendorBids() map[string]*any1.Any {
	if x != nil {
		return x.VendorBids
	}
	return nil
