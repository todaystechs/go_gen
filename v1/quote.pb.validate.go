...
func (m *Quote) validate(all bool) error {
	...
	for idx, item := range m.GetVendorBids() {
		_, _ = idx, item
		...
		if all {
			...
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, QuoteValidationError{
						field:  fmt.Sprintf("VendorBids[%v]", idx),
						reason: "embedded message failed validation",
						cause:  err,
					})
				}
...
// Validate checks the field values on VendorBids with the rules defined in the
// proto definition for this message. If any rules are violated, the first
// error encountered is returned, or nil if there are no violations.
func (m *VendorBids) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on VendorBids with the rules defined in
// the proto definition for this message. If any rules are violated, the
// result is a list of violation errors wrapped in VendorBidsMultiError, or
// nil if none found.
func (m *VendorBids) ValidateAll() error {
	return m.validate(true)
}

func (m *VendorBids) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	// no validation rules for VendorBids

	if len(errors) > 0 {
		return VendorBidsMultiError(errors)
	}

	return nil
}

// VendorBidsMultiError is an error wrapping multiple validation errors
// returned by VendorBids.ValidateAll() if the designated constraints aren't met.
type VendorBidsMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m VendorBidsMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m VendorBidsMultiError) AllErrors() []error { return m }

// VendorBidsValidationError is the validation error returned by
// VendorBids.Validate if the designated constraints aren't met.
type VendorBidsValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e VendorBidsValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e VendorBidsValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e VendorBidsValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e VendorBidsValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e VendorBidsValidationError) ErrorName() string { return "VendorBidsValidationError" }

// Error satisfies the builtin error interface
func (e VendorBidsValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
...
var _ error = VendorBidsValidationError{}
