...
type SendEmail struct {
	...
	ReceiverEmailAddress string `protobuf:"bytes,2,opt,name=receiver_email_address,json=receiver_email_address,omitempty,proto3" json:"receiver_email_address,omitempty"`
