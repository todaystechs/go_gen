...
type Address struct {
	...
	FreeFormAddress string `protobuf:"bytes,10,opt,name=free_form_address,json=free_form_address,omitempty,proto3" json:"free_form_address,omitempty" dynamodbav:"free_form_address,omitempty"`
