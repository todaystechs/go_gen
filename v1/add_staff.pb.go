...
type AddStaffData struct {
	...
	Roles []Role `protobuf:"varint,2,rep,packed,name=roles,proto3,enum=user.Role" json:"roles,omitempty" dynamodbav:"roles,omitempty"`
	// @gotags: dynamodbav:"new_staff_email,omitempty"
	NewStaffEmail string `protobuf:"bytes,3,opt,name=new_staff_email,json=newStaffEmail,proto3" json:"new_staff_email,omitempty" dynamodbav:"new_staff_email,omitempty"`
...
func (x *AddStaffData) GetPassword() string {
	if x != nil {
		return x.Password
	}
	return ""
...
var file_add_staff_proto_rawDesc = []byte{
	...
	0x61, 0x70, 0x70, 0x65, 0x72, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xb8, 0x01, 0x0a,
	...
	0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x42, 0x6b, 0x0a, 0x08, 0x63, 0x6f, 0x6d, 0x2e, 0x75,
	0x73, 0x65, 0x72, 0x42, 0x0d, 0x41, 0x64, 0x64, 0x53, 0x74, 0x61, 0x66, 0x66, 0x50, 0x72, 0x6f,
