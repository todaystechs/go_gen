...
var file_user_proto_rawDesc = []byte{
	...
	0x65, 0x6e, 0x18, 0x01, 0x20, 0x03, 0x28, 0x09, 0x52, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x42,
	0x67, 0x0a, 0x08, 0x63, 0x6f, 0x6d, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x42, 0x09, 0x55, 0x73, 0x65,
...
var file_user_proto_goTypes = []interface{}{
	...
	nil,                     // 2: user.UserData.ResetPasswordTokenEntry
	(Role)(0),               // 3: user.Role
	(*PhoneNumberData)(nil), // 4: user.PhoneNumberData
	(*Status)(nil),          // 5: user.Status
}
var file_user_proto_depIdxs = []int32{
	3, // 0: user.UserData.roles:type_name -> user.Role
	4, // 1: user.UserData.phone_numbers:type_name -> user.PhoneNumberData
	2, // 2: user.UserData.reset_password_token:type_name -> user.UserData.ResetPasswordTokenEntry
	5, // 3: user.UserData.status:type_name -> user.Status
