...
type DynamoUserEntity struct {
	...
	// @gotags: dynamodbav:"user_index_pk,omitempty"
	UserIndexPk string `protobuf:"bytes,3,opt,name=user_index_pk,json=userIndexPk,proto3" json:"user_index_pk,omitempty" dynamodbav:"user_index_pk,omitempty"`
	// @gotags: dynamodbav:"user_index_sk,omitempty"
	UserIndexSk string `protobuf:"bytes,4,opt,name=user_index_sk,json=userIndexSk,proto3" json:"user_index_sk,omitempty" dynamodbav:"user_index_sk,omitempty"`
	// @gotags: dynamodbav:"user_entity,omitempty"
	UserEntity map[string]*UserData `protobuf:"bytes,5,rep,name=user_entity,json=userEntity,proto3" json:"user_entity,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3" dynamodbav:"user_entity,omitempty"`
}
...
func (x *DynamoUserEntity) GetUserIndexPk() string {
	if x != nil {
		return x.UserIndexPk
	}
	return ""
}

func (x *DynamoUserEntity) GetUserIndexSk() string {
	if x != nil {
		return x.UserIndexSk
	}
	return ""
}

func (x *DynamoUserEntity) GetUserEntity() map[string]*UserData {
	if x != nil {
		return x.UserEntity
	}
	return nil
...
var file_user_proto_rawDesc = []byte{
	...
	0x20, 0x03, 0x28, 0x09, 0x52, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x92, 0x02, 0x0a, 0x10,
	...
	,
...
var file_user_proto_goTypes = []interface{}{
	...
	nil,                      // 4: user.DynamoUserEntity.UserEntityEntry
	(Role)(0),                // 5: user.Role
	(*PhoneNumberData)(nil),  // 6: user.PhoneNumberData
}
var file_user_proto_depIdxs = []int32{
	5, // 0: user.UserData.roles:type_name -> user.Role
	6, // 1: user.UserData.phone_numbers:type_name -> user.PhoneNumberData
	3, // 2: user.UserData.reset_password_token:type_name -> user.UserData.ResetPasswordTokenEntry
	4, // 3: user.DynamoUserEntity.user_entity:type_name -> user.DynamoUserEntity.UserEntityEntry
	0, // 4: user.DynamoUserEntity.UserEntityEntry.value:type_name -> user.UserData
