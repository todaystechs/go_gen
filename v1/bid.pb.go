...
type Bid struct {
	...
	CompanyLogoUrl string `protobuf:"bytes,8,opt,name=company_logo_url,json=companyLogoUrl,proto3" json:"company_logo_url,omitempty"`
	...
	VendorQuoteId string `protobuf:"bytes,10,opt,name=vendor_quote_id,json=vendorQuoteId,proto3" json:"vendor_quote_id,omitempty"`
	// @gotags: dynamodbav:"capacity_provider_quote_id,omitempty"
	CapacityProviderQuoteId string `protobuf:"bytes,11,opt,name=capacity_provider_quote_id,json=capacityProviderQuoteId,proto3" json:"capacity_provider_quote_id,omitempty"`
...
var file_bid_proto_rawDesc = []byte{
	...
	0x0d, 0x63, 0x61, 0x72, 0x72, 0x69, 0x65, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xae,
	...
	0x0a, 0x0b, 0x76, 0x65, 0x6e, 0x64, 0x6f, 0x72, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x0c, 0x20,
