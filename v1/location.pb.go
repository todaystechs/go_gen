...
type Location struct {
	...
	LocationServices LocationServices `protobuf:"varint,27,opt,name=location_services,json=locationServices,proto3,enum=user.LocationServices" json:"location_services,omitempty" dynamodbav:"location_services,omitempty"`
}
...
func (x *Location) GetLocationServices() LocationServices {
	...
	return LocationServices_pickup_location_with_dock
}
...
var file_location_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x0e, 0x32, 0x17, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x6c, 0x6f, 0x63, 0x61, 0x74,
