...
var file_location_proto_rawDesc = []byte{
	...
	0x69, 0x73, 0x74, 0x73, 0x4f, 0x66, 0x4c, 0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x42, 0x6b,
...
var file_location_proto_goTypes = []interface{}{
	...
	(LocationType)(0),       // 4: user.LocationType
	(AdditionalService)(0),  // 5: user.AdditionalService
	(*BusinessHour)(nil),    // 6: user.BusinessHour
}
var file_location_proto_depIdxs = []int32{
	...
	4, // 2: user.Location.location_type:type_name -> user.LocationType
	5, // 3: user.Location.additional_service:type_name -> user.AdditionalService
	6, // 4: user.Location.business_hours:type_name -> user.BusinessHour
