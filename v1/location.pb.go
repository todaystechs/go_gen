...
type Location_Services int32

const (
	// @gotags: dynamodbav:"pickup_location_with_dock,omitempty"
	Location_Services_pickup_location_with_dock Location_Services = 0
	// @gotags: dynamodbav:"liftgate_pickup,omitempty"
	Location_Services_liftgate_pickup Location_Services = 1
	// @gotags: dynamodbav:"pickup_appointment,omitempty"
	Location_Services_pickup_appointment Location_Services = 2
	// @gotags: dynamodbav:"inside_pickup,omitempty"
	Location_Services_inside_pickup Location_Services = 3
	// @gotags: dynamodbav:"pickup_notification,omitempty"
	Location_Services_pickup_notification Location_Services = 4
	// @gotags: dynamodbav:"delivery_location_with_dock,omitempty"
	Location_Services_delivery_location_with_dock Location_Services = 5
	// @gotags: dynamodbav:"liftgate_delivery,omitempty"
	Location_Services_liftgate_delivery Location_Services = 6
	// @gotags: dynamodbav:"delivery_appointment,omitempty"
	Location_Services_delivery_appointment Location_Services = 7
	// @gotags: dynamodbav:"inside_delivery,omitempty"
	Location_Services_inside_delivery Location_Services = 8
	// @gotags: dynamodbav:"delivery_notification,omitempty"
	Location_Services_delivery_notification Location_Services = 9
)

// Enum value maps for Location_Services.
var (
	Location_Services_name = map[int32]string{
	...
	Location_Services_value = map[string]int32{
...
func (x Location_Services) Enum() *Location_Services {
	p := new(Location_Services)
	*p = x
	return p
}

func (x Location_Services) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (Location_Services) Descriptor() protoreflect.EnumDescriptor {
	return file_location_proto_enumTypes[0].Descriptor()
}

func (Location_Services) Type() protoreflect.EnumType {
	return &file_location_proto_enumTypes[0]
}

func (x Location_Services) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use Location_Services.Descriptor instead.
func (Location_Services) EnumDescriptor() ([]byte, []int) {
...
type Location struct {
	...
	LocationServices []int32 `protobuf:"varint,27,rep,packed,name=location_services,json=locationServices,proto3" json:"location_services,omitempty" dynamodbav:"location_services,omitempty"`
}
...
func (x *Location) GetLocationServices() []int32 {
	if x != nil {
...
var file_location_proto_rawDesc = []byte{
	...
	0x72, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xc8, 0x08, 0x0a, 0x08, 0x4c, 0x6f, 0x63,
	...
	0x63, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x12, 0x2b, 0x0a, 0x11, 0x6c, 0x6f, 0x63, 0x61, 0x74, 0x69,
	0x6f, 0x6e, 0x5f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x18, 0x1b, 0x20, 0x03, 0x28,
	0x05, 0x52, 0x10, 0x6c, 0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x53, 0x65, 0x72, 0x76, 0x69,
	...
	0x11, 0x4c, 0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63,
...
var file_location_proto_goTypes = []interface{}{
	(Location_Services)(0), // 0: v1.Location_Services
...
var file_location_proto_depIdxs = []int32{
	...
	1, // 3: v1.Locations.Locations:type_name -> v1.Location
